...
import {clamp, getValueForPosition, isLowCloser,   nativeEventProps} from './helpers';
...
const Slider: React.FC<SliderProps> = ({
  ...
  const handleThumbLayout = useCallback(({nativeEvent}: { nativeEvent: nativeEventProps }) => {
  ...
  return (
    <View  {...restProps}>
      <View {...labelContainerProps}>
          {   console.log(labelContainerProps, 'test for value') }
